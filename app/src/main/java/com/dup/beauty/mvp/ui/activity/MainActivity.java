 ...
 * Dagger2:
 * <li>{@link ActivityComponent}</li>
 * <li>{@link ActivityModule}</li>
 * </ul>
 */
public class MainActivity extends BaseActivity implements IMainContentView, IMainMenuView, BGABanner.OnItemClickListener,
     ...
     */
    @Inject
    public MainContentPresenter mMainContentPresenter;

    /**
     * 主界面menu的presenter
     */
    @Inject
    public MainMenuPresenter mMainMenuPresenter;
    ...
    protected void bindViewToPresenters() {
        mMainContentPresenter.attachView(this);
